...
def get_args():
    parser = argparse.ArgumentParser(description="CIRAF Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--mlm_loss_weight", type=float, default=2.0, help="mlm loss weight")
    parser.add_argument("--id_loss_weight", type=float, default=1.0, help="id loss weight")
    parser.add_argument("--att_loss_weight", type=float, default=1.0, help="att  loss weight")
    ...
    parser.add_argument(
        "--model-ema", default=True, help="enable tracking Exponential Moving Average of model parameters"
    )
    parser.add_argument(
        "--model-ema-steps",
        type=int,
